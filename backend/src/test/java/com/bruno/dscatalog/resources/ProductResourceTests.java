package com.bruno.dscatalog.resources;
...
import com.bruno.dscatalog.services.ProductService;
...
public class ProductResourceTests {
	...
	@Test
	public void insertShouldReturnProductDTOAndStatusCodeCreatedWhenIdExists() throws Exception {
		String jsonBody = objectMapper.writeValueAsString(productDTO);
		ResultActions result = mockMvc.perform(post("/products").content(jsonBody).accept(MediaType.APPLICATION_JSON)
